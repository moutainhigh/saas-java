package com.hq.storeLog.logHandle.customer;
...
public class CustomerMSLogHandler implements IStoreLogHandler {
	private static Logger logger = LoggerFactory.getLogger(CustomerMSLogHandler.class);
