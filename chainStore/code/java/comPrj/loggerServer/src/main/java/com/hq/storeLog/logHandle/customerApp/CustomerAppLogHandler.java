package com.hq.storeLog.logHandle.customerApp;
...
public class CustomerAppLogHandler implements IStoreLogHandler {
	private static Logger logger = LoggerFactory.getLogger(CustomerAppLogHandler.class);
