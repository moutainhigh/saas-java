package com.hq.storeLog.logHandle.order;
...
public class OrderMSLogHandler implements IStoreLogHandler {
	private static Logger logger = LoggerFactory.getLogger(OrderMSLogHandler.class);
