package com.hq.storeLog.logHandle.storeManager;
...
public class StoreManagerMSLogHandler implements IStoreLogHandler {
	private static Logger logger = LoggerFactory.getLogger(StoreManagerMSLogHandler.class);
