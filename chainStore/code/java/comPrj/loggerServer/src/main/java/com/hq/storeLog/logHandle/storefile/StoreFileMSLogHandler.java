package com.hq.storeLog.logHandle.storefile;
...
public class StoreFileMSLogHandler implements IStoreLogHandler {
	private static Logger logger = LoggerFactory.getLogger(StoreFileMSLogHandler.class);
