package com.hq.storeLog.logHandle.storems;
...
public class StoreMSLogHandler implements IStoreLogHandler {
	private static Logger logger = LoggerFactory.getLogger(StoreMSLogHandler.class);
