package com.hq.storeLog.logHandle.storeweb;
...
public class StoreWebLogHandler implements IStoreLogHandler {
	private static Logger logger = LoggerFactory.getLogger(StoreWebLogHandler.class);
