package com.hq.storeLog.logHandle.thirdparty;
...
public class ThirdParyMSLogHandler implements IStoreLogHandler {
	private static Logger logger = LoggerFactory.getLogger(ThirdParyMSLogHandler.class);
