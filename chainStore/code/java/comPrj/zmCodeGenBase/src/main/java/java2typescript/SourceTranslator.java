...
public class SourceTranslator {
    ...
    public void generate() {
        ...
        try {
        	...
        	String[] folders = new String[] {"bs","apiData","data"};
    		for (String folder : folders) {
    			String module = name.replaceAll(FileUtils.upFirstChar(folder), "");
    			result = result.replaceAll("com.hq.chainStore.service."+module+"."+folder+".", "");
    		}
        	
            FileUtil.writeToFile(modelFile, result.getBytes());
