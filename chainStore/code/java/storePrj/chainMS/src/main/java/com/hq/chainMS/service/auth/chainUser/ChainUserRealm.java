...
public class ChainUserRealm extends AuthorizingRealm {
	...
	protected AuthorizationInfo doGetAuthorizationInfo(PrincipalCollection principals) {
		...
		ChainUserAuthInfo authInfo = ChainUserMgr.getInstance().findRolePermInfoByPhone(phone);
	...
	protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken token) throws AuthenticationException {
		...
		ChainUser user = ChainUserMgr.getInstance().findByPhone(phone);
		if (user == null) {
