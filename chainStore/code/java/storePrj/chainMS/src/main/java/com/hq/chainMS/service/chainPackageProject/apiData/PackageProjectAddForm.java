...
public class PackageProjectAddForm {
	...
	public PackageProjectDetail toPackageProjectDetail(long chainId) {
		PackageProjectDetail data = PackageProjectDetail.newInstance();
		FastBeanCopyer.getInstance().copy(this, data);
		data.setChainId(chainId);
		data.setId(PackageProject.generateId(chainId, index));
		return data;
	}

	public PackageProject toPackageProject(long chainId) {
