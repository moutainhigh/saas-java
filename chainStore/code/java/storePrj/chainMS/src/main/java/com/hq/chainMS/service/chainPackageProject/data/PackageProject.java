...
public class PackageProject {
	...
	public static String generateId(long chainId, long index) {
		return AppUtils.joinByUnderline(ServerConstants.CHAIN_PACKAGE_PROJECT_ID_SUFFIX, chainId, index);
	}
	
	public SellProduct toSellProduct() {
		SellProduct data = SellProduct.newInstance();
		FastBeanCopyer.getInstance().copy(this, data);
		data.setSellProductType(SellProductTypeEnum.PACKAGE.ordinal());
		return data;
	}
