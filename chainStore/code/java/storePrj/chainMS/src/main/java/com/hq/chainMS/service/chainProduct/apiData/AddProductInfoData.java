...
public class AddProductInfoData {
	...
	public Product toProductInfo(long chainId) {
		Product data = Product.newInstance();
		BeanUtils.copyProperties(this, data);
		data.setId(Product.generateId(chainId, index));
		return data;
	}

	public ProductDetail toProductDetail(long chainId) {
