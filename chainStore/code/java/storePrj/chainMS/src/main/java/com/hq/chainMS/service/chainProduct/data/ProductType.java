...
public class ProductType {
	...
	public static ProductType newInstance() {
		...
		type.createTime = currentTimeMillis;
		type.lastUpdateTime = currentTimeMillis;
		return type;
	}
	
	public static String generateId(long chainId, long index) {
		return AppUtils.joinByUnderline(ServerConstants.CHAIN_PRODUCT_TYPE_ID_SUFFIX, chainId, index);
	}
