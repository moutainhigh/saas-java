...
public class ChainUserDto {
	...
	public static ChainUserDto newInstance(ChainUser data) {
		ChainUserDto dto = new ChainUserDto();
		FastBeanCopyer.getInstance().copy(data, dto);
		dto.setStoreIds(data.takeStoreIds());
		return dto;
	}

	public void addStoreNames(Map<Long, Store> storeMap) {
	...
	public void addAdminRoles(Set<AdminRole> adminRolesP) {
		adminRoles.addAll(adminRolesP);
	}
