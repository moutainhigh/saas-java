...
public enum RespStatus {
	...
	public int getCode() {
	 ...
	 public static RespStatus getRespStatusEnumByCode(int code){
		 RespStatus respStatus = null;
		 for(RespStatus respStatusEnum : RespStatus.values()){
		     if(code==respStatusEnum.getCode()){
		    	 respStatus = respStatusEnum;
		     }
		 }
		return respStatus;
	 }
