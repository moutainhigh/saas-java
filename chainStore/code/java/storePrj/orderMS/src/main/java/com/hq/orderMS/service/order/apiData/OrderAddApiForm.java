...
import com.hq.orderMS.service.order.data.DelimitCardItem;
import com.hq.orderMS.service.order.data.DonationItem;
import com.hq.orderMS.service.order.data.Order;
import com.hq.orderMS.service.order.data.OrderDataTypeEnum;
import com.hq.orderMS.service.order.data.PreStoreCardItem;
import com.hq.orderMS.service.order.data.RechargeItem;
...
public class OrderAddApiForm {
	...
	public Order toOrder() {
		...
		if (recordType == OrderDataTypeEnum.OLD_RCD.ordinal()) {
			data.setCreatedTime(orderTime);
		}
		return data;
	}
