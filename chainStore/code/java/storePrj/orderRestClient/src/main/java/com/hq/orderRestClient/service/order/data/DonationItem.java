...
public class DonationItem {
	...
	public static DonationItem newInstance(int buyTypeP, String pgIdP) {
		DonationItem data = new DonationItem();
		data.buyType = buyTypeP;
		data.pgId = pgIdP;
		data.donationItemId = StringFormatUtil.format("{}_{}_{}", OrderClientConstants.ORDER_DONATION_ITEM_ID_SUFFFIX, buyTypeP, pgIdP); 
		return data;
	}
