...
public class Order {
	...
	public static Order newInstance() {
		...
		order.orderType = OrderTypeEnum.PURCHASE.ordinal();
	...
	public BuyItem takeBuyItem(String itemId) {
		for (BuyItem item : buyItems) {
			if (item.getBuyItemId().equals(itemId)) {
				return item;
			}
		}
		return null;
	...
	public DelimitCardItem takeDelimitCardItem(String itemId) {
		for (DelimitCardItem item : delimitCardItems) {
			if (item.getDelimitCardItemId().equals(itemId)) {
				return item;
			}
		}
		return null;
	...
	public DonationItem takeDonationItem(String itemId) {
		for (DonationItem item : donationItems) {
			if (item.getDonationItemId().equals(itemId)) {
				return item;
			}
		}
		return null;
