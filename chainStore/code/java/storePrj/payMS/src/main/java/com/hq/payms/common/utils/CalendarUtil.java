...
public class CalendarUtil {
	...
	public static String solarToLunar(String solarDate) throws Exception {
		...
		return "阴历：" + lunarYear + "年"
				+ (leapMonthFlag & (lunarMonth == leapMonth) ? "闰" : "")
				+ lunarMonth + "月" + lunarDay + "日";
	}
	
	public static String addMinutes2NowTime(int minutes, String pattern) {
	...
	public static void main(String[] args) {
		String result = addMinutes2NowTime(5, "yyyyMMddHHmmss");
