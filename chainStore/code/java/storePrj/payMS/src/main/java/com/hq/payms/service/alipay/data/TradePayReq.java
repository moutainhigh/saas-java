...
public class TradePayReq extends CommonReq implements IntfNotifiableReq {
    ...
    private String authCode; // 条码示例，286648048691290423
	...
	public static TradePayReq newInstance() {
		TradePayReq instance = new TradePayReq();
