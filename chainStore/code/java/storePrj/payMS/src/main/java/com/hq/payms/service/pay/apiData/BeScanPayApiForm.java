...
public class BeScanPayApiForm{
	 ...
	 * @return
	 */
	public UnifiedOrderApiForm toUnifiedOrderApiForm(){
		UnifiedOrderApiForm target = UnifiedOrderApiForm.newInstance();
	 ...
	 * @return
	 */
	public TradePrecreateApiForm toTradePrecreateApiForm() {
		TradePrecreateApiForm target = TradePrecreateApiForm.newInstance();
		FastBeanCopyer.getInstance().copy(this, target);
		target.setStoreId(this.getStoreId());
		return target;
	}
