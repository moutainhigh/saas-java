...
/**
 * 在<cdoe>com.alipay.api.DefaultAlipayClient</code>基础上做了修改<br>
 * 1,改appId,privateKey,alipayPublicKey的setter方法为共有<br>
 * 2,使http连接、读超时时间可配置
 * @author: wujunwei 
 * @version: v1.0  
 * @since: JDK 1.8
 */
public class ZmAlipayClient implements AlipayClient {
	...
	public ZmAlipayClient(String serverUrl, String appId, String privateKey) {
		this.serverUrl = serverUrl;
		this.appId = appId;
		this.privateKey = privateKey;
	}

	public ZmAlipayClient(String serverUrl, String appId, String privateKey, String format) {
		this(serverUrl, appId, privateKey);
		this.format = format;
	}

	public ZmAlipayClient(String serverUrl, String appId, String privateKey, String format, String charset) {
...
//			AlipayLogger.logErrorScene(rt, tRsp, ""); 
			String logInfo = ZmAlipayLogHelper.getLogInfo(rt, tRsp);
			ConsoleLog.info(LogModule.Alipay, "ZmAlipayClient[_execute]", logInfo);
			MainLog.info(LogModule.Alipay, "ZmAlipayClient[_execute]", logInfo);
		}
		return tRsp;
	}
	...
	public static class Builder {
		...
		Builder(String serverUrl, String appId, String privateKey) {
			client = new ZmAlipayClient(serverUrl, appId, privateKey);
		}
