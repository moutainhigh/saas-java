...
public abstract class ZmSafeNormalAbsAlipayTradeService  extends AbsAlipayService{
	protected static ExecutorService executorService = Executors.newCachedThreadPool();
//    protected AlipayClient client; //client不再共享，而是作为参数传入

    public AlipayF2FQueryResult queryTradeResult(AlipayClient client, AlipayTradeQueryRequestBuilder builder) {
        AlipayTradeQueryResponse response = tradeQuery(client, builder);
    ...
    protected AlipayTradeQueryResponse tradeQuery(AlipayClient client, AlipayTradeQueryRequestBuilder builder) {
    ...
    public AlipayF2FRefundResult tradeRefund(AlipayClient client, AlipayTradeRefundRequestBuilder builder) {
        validateBuilder(builder);
    ...
    public AlipayF2FPrecreateResult tradePrecreate(AlipayClient client, AlipayTradePrecreateRequestBuilder builder) {
        validateBuilder(builder);
    ...
    protected AlipayF2FPayResult checkQueryAndCancel(AlipayClient client, String outTradeNo, String appAuthToken, AlipayF2FPayResult result,
        ...
        AlipayTradeCancelResponse cancelResponse = cancelPayResult(client, builder);
    ...
    protected AlipayTradeCancelResponse tradeCancel(AlipayClient client, AlipayTradeCancelRequestBuilder builder) {
        validateBuilder(builder);
    ...
    // 轮询查询订单支付结果
    protected AlipayTradeQueryResponse loopQueryResult(AlipayClient client, AlipayTradeQueryRequestBuilder builder) {
    ...
    // 根据外部订单号outTradeNo撤销订单
    protected AlipayTradeCancelResponse cancelPayResult(AlipayClient client, AlipayTradeCancelRequestBuilder builder) {
        AlipayTradeCancelResponse response = tradeCancel(client, builder);
        ...
        if (needRetry(response)) {
            ...
            asyncCancel(client, builder);
        }
        return response;
    }

    // 异步撤销
    protected void asyncCancel(AlipayClient client, final AlipayTradeCancelRequestBuilder builder) {
