...
public class ZmWXPayDomainSimpleImpl implements IWXPayDomain {
	
	private ZmWXPayDomainSimpleImpl() {
	}

	private static class WxpayDomainHolder {
		private static IWXPayDomain holder = new ZmWXPayDomainSimpleImpl();
	}
