...
import com.github.wxpay.sdk.WXPayReport;
 ...
 * 
 * 存在线程安全性问题<br>
 * replaced by <code>ZmSafeNormalWXPayRequest</code>
 * 
 * @author: wujunwei 
 * @version: v1.0  
 * @since: JDK 1.8
 */
public class ZmNormalWXPayRequest {
	
	public static ZmNormalWXPayRequest getInstance(){
		return HotSwap.getInstance().getSingleton(ZmNormalWXPayRequest.class);
	}
     ...
     * @param configP
     */
    public void setConfig(WXPayConfig conifgP) {
    	this.config = conifgP;
    }
