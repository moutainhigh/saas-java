...
import com.hq.storeClient.service.buserDevice.data.BUserDevice;
import com.hq.storeClient.service.buserDevice.data.BUserDeviceDAO;
import com.hq.storeClient.service.buserDevice.data.MCtrlLockApiForm;
 ...
 * 
 */
public class BUserDeviceClientMgr {

	public static BUserDeviceClientMgr getInstance() {
		return HotSwap.getInstance().getSingleton(BUserDeviceClientMgr.class);
	}
