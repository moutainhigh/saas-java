...
import com.hq.storeClient.service.dynamic.data.DynamicStatusEnum;
...
public class DynamicQueryFormForCuser {
	...
	public ReqMap toReqMap() {
		...
		reqMap.add("minTime", minTime).add("maxTime", maxTime).add("buserIds", StringUtils4Client.join(buserIds, ","))
				.add("content", content);
		return reqMap;
	}
