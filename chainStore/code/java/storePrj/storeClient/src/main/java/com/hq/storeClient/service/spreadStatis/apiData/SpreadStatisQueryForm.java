package com.hq.storeClient.service.spreadStatis.apiData;
...
public class SpreadStatisQueryForm {
	...
	public ReqMap toReqMap() {
		...
		reqMap.add("storeId", storeId).add("minTime", minTime).add("maxTime", maxTime).add("buserId", buserId)
				.add("dynamicId", dynamicId).add("pageItemCount", pageItemCount).add("pageNo", pageNo);
		return reqMap;
	}
