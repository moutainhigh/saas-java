...
public class ClerkPayroll {
	...
	public static ClerkPayroll newInstance(String date){
		ClerkPayroll clerkPayroll = new ClerkPayroll();
		clerkPayroll.date = date;
		clerkPayroll.createTime = System.currentTimeMillis();
		return clerkPayroll;
	}
