...
/** 
 * @ClassName: ExcelGoods 
 * @Description:由excel表格导出来的对象 => {@link GoodsAddForm}
 * 				需特殊处理的字段 typeId
 * @author helen 
 * @date 2018年4月3日 下午2:34:04 
 *  
 */
@SynClass
public class ExcelGoods {
	...
	public String toString() {
		return "ExcelGoods [number=" + number + ", name=" + name + ", typeId="
				+ typeId + ", price=" + price + ", cost=" + cost
				+ ", descript=" + descript + "]";
	}
