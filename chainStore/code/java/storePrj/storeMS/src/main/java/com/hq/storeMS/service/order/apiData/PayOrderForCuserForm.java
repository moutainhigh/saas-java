...
public class PayOrderForCuserForm {
	...
	public PayOrderWithNoteApiForm toPayOrderWithNoteApiForm() {
		PayOrderWithNoteApiForm data = PayOrderWithNoteApiForm.newInstance();
		data.getPayItems().addAll(payItems);
		return data;
	}
