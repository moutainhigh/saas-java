...
public class ChargeBackDetail {
	...
	public static ChargeBackDetail newInstance() {
		return new ChargeBackDetail();
	}
	
	public static ChargeBackDetail newInstanceByChargeBackRecord(ChargeBackRecord record) {
		ChargeBackDetail data = newInstance();
		BeanUtils.copyProperties(record, data, "chargeBackItems");
		return data;
	}
