...
public class DelimitCardDetail {
	...
	public static DelimitCardDetail newInstanceByDelimitCardItem(DelimitCardItem delimitCardItem) {
		DelimitCardDetail data = new DelimitCardDetail();
		FastBeanCopyer.getInstance().copy(delimitCardItem, data);
		return data;
	}
	
	public static DelimitCardDetail newInstanceByPreStoreCardItem(PreStoreCardItem item) {
		DelimitCardDetail data = new DelimitCardDetail();
		FastBeanCopyer.getInstance().copy(item, data);
		data.setDelimitCardItemId(item.getId());
		data.setPrdCardName("预存卡");
		return data;
	}
