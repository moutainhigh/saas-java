...
public class ProductCardDetail {
	...
	public static ProductCardDetail newInstanceByProductCard(ProductCard data, long storeId) {
		ProductCardDetail result = AppUtils.copyBeanBySerialize(data, ProductCardDetail.class);
