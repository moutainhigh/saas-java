...
public class AddMembershipCard {
	...
	public MembershipCard toMembershipCard(long storeId) {
		MembershipCard data = MembershipCard.newInstance();
		BeanUtils.copyProperties(this, data, "descript");
		data.setId(MembershipCard.generateId(storeId, index));
		return data;
	}

	public MembershipCardDetail toMembershipCardDetail(long storeId) {
