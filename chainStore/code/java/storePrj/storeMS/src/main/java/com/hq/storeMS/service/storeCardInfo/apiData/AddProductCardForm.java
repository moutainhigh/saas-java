...
public class AddProductCardForm {
	private int index;
	// 编号
	...
	public static AddProductCardForm newInstance() {
		return new AddProductCardForm();
	}

	public ProductCard toProductCard(long storeId) {
		ProductCard data = ProductCard.newInstance();
		BeanUtils.copyProperties(this, data, "descript", "index");
		data.setId(ProductCard.generateId(storeId, index));
		return data;
	}

	public ProductCardDetail toProductCardDetail(long storeId) {
		ProductCardDetail data = ProductCardDetail.newInstance();
