...
public class DiscountCard {
	...
	public String generateId(long storeId, int index) {
		return ServerConstants.STORE_DISCOUNTCARD_ID_SUFFFIX + "_" +storeId + "_" + index;
	}

	public static DiscountCard newInstance() {
		DiscountCard data = new DiscountCard();
		data.status = CardStatusEnum.NEW.ordinal();
		data.cardType = CardTypeEnum.UNKNOW.ordinal();
		data.consumeType = ConsumeTypeEnum.UNKNOWN.ordinal();
		return data;
	}
