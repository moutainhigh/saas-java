...
public class StoreConfigUpdateForm {
	...
	public StoreConfigUpdateType getStoreConfigUpdateType() {
		return StoreConfigUpdateType.valueOf(updateType);
	}
	
	public void setStoreConfigUpdateType(StoreConfigUpdateType storeConfigUpdateType) {
		updateType = storeConfigUpdateType.ordinal();
	}
