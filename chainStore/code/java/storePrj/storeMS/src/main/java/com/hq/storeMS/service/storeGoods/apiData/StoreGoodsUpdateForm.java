...
public class StoreGoodsUpdateForm {
	...
	private List<ExcelGoods> addListFromExcel;
	private List<GoodsTmp> addListFromStore;
	...
	public List<ExcelGoods> getAddListFromExcel() {
		return addListFromExcel;
	}

	public void setAddListFromExcel(List<ExcelGoods> addListFromExcel) {
		this.addListFromExcel = addListFromExcel;
	}

	public List<GoodsTmp> getAddListFromStore() {
		return addListFromStore;
	}

	public void setAddListFromStore(List<GoodsTmp> addListFromStore) {
