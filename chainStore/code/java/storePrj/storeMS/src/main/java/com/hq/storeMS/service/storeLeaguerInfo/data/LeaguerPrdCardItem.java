...
public class LeaguerPrdCardItem {
	...
	public static LeaguerPrdCardItem newInstance(ProductCardItem productCardItem) {
		LeaguerPrdCardItem data = newInstance();
		FastBeanCopyer.getInstance().copy(productCardItem, data);
		data.setRestCount(productCardItem.getCount());
		return data;
	}
