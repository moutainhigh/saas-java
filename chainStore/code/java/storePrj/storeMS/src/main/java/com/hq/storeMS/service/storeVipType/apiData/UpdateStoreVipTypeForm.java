...
public class UpdateStoreVipTypeForm {
	...
	public static UpdateStoreVipTypeForm newInstance(){
		return new UpdateStoreVipTypeForm();
	}
	...
	public StoreVipType toStoreVipType(StoreVipType storeVipType){
