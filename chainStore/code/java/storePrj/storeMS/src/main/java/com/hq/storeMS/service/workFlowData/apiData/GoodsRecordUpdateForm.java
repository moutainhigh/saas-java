...
public class GoodsRecordUpdateForm {
	private String id;
	// 商品ID
	...
	public static GoodsRecordUpdateForm newInstance() {
		return new GoodsRecordUpdateForm();
	}
	
	public void updateGoodsRecord(GoodsRecord data) {
