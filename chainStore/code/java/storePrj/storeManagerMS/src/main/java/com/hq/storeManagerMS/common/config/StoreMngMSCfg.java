 ...
 */
@ConfigurationProperties(prefix = "storemngms.prop")
public class StoreMngMSCfg {
	...
	private String fileMSHost;
	private String storeMSHost;
	private String iotMSHost;
	...
	public String getFileMSHost() {
		return fileMSHost;
	}

	public void setFileMSHost(String fileMSHost) {
		this.fileMSHost = fileMSHost;
	}
	...
	public String getIotMSHost() {
		return iotMSHost;
	}

	public void setIotMSHost(String iotMSHost) {
		this.iotMSHost = iotMSHost;
	}
