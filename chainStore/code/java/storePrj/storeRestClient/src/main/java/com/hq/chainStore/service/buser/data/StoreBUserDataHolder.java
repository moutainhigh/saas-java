...
public class StoreBUserDataHolder extends AbsDetailDataHolder<StoreBUser> {

	public static StoreBUserDataHolder getInstance() {
		return HotSwap.getInstance().getSingleton(StoreBUserDataHolder.class);
	}

	final private DataVersionEnum versionEnum = DataVersionEnum.StoreBUser;

	protected RestDao<StoreBUser> getDao() {
		return StoreBUserDAO.getInstance();
	}
