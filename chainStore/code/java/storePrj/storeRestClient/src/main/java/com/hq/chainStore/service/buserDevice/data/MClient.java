...
public class MClient  {
	...
	public String toString() {
		return "MClient [id=" + id + ", clientId=" + clientId + ", mseriesId="
				+ mseriesId + ", mseriesName=" + mseriesName + ", mtypeId="
				+ mtypeId + ", mtypeName=" + mtypeName + ", snCode=" + snCode
				+ ", imsiCode=" + imsiCode + ", secretKey=" + secretKey
				+ ", bandingSystem=" + bandingSystem + ", bandingAccount="
				+ bandingAccount + ", status=" + status + ", isActivated="
				+ isActivated + ", location=" + location + ", locationGps="
				+ locationGps + ", locationUrl=" + locationUrl + ", ctrlState="
				+ ctrlState + ", bandingTime=" + bandingTime + ", createdTime="
