...
public class OrderUpdateApiForm {
	...
	/** =========================遗留的字段========================= **/
	@Deprecated
	private UpdateOrderMaterialForm updateOrderMaterialData;
	...
	@Deprecated
	public UpdateOrderMaterialForm getUpdateOrderMaterialData() {
		return updateOrderMaterialData;
	}

	@Deprecated
	public void setUpdateOrderMaterialData(
			UpdateOrderMaterialForm updateOrderMaterialData) {
		this.updateOrderMaterialData = updateOrderMaterialData;
	}
