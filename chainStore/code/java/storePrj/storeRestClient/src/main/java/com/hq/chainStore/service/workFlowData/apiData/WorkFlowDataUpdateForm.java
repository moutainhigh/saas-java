...
public class WorkFlowDataUpdateForm {
	...
	public void setUpdWorkFlowDataInfoForm(
			WorkFlowDataUpdateInfoForm updWorkFlowDataInfoForm) {
	...
	public void setWorkFlowDataStatusForm(
			WorkFlowDataUpdateStatusForm workFlowDataStatusForm) {
	...
	public void setWorkFlowDataBuyItemsForm(
			WorkFlowDataUpdateBuyItemsForm workFlowDataBuyItemsForm) {
