...
import com.hq.chainStore.service.orderNotes.bs.OrderNotesMgr;
...
public class OrderNotesMgrTest {
	...
	public void testGet() {
		AccessTokenMgr.getInstance().setOpIdTL(boss.getId());
		long orderId = 1737L;
		OrderNotes orderNotes = OrderNotesMgr.getInstance().getOrderNotes(storeId, orderId);
